...
-- ===============================
-- 개인 Projects (포트폴리오) - 간단한 이미지 URL 사용
-- ===============================
...
-- ===============================
-- Project Details (상세 이미지/설명) - 간단한 이미지 URL 사용
-- ===============================
-- 프로젝트 1 상세
INSERT INTO project_details (project_id, title, description, image_url)
VALUES (1, '메인 페이지', '프로젝트 목록과 검색 기능이 있는 메인 화면', '/img/detail-main.jpg');

INSERT INTO project_details (project_id, title, description, image_url)
VALUES (1, '프로젝트 상세 페이지', '개별 프로젝트의 상세 정보와 갤러리 기능', '/img/detail-detail.jpg');

INSERT INTO project_details (project_id, title, description, image_url)
VALUES (1, '관리자 페이지', '프로젝트 등록/수정/삭제가 가능한 관리자 인터페이스', '/img/detail-admin.jpg');

-- 프로젝트 2 상세
INSERT INTO project_details (project_id, title, description, image_url)
VALUES (2, '게시판 목록', 'Bootstrap을 활용한 반응형 게시판 목록 화면', '/img/board-list.jpg');

INSERT INTO project_details (project_id, title, description, image_url)
VALUES (2, '게시글 작성', '파일 업로드와 에디터가 포함된 게시글 작성 폼', '/img/board-write.jpg');

INSERT INTO project_details (project_id, title, description, image_url)
VALUES (2, '로그인 시스템', 'Spring Security를 활용한 로그인/회원가입 기능', '/img/board-login.jpg');

-- 프로젝트 3 상세
INSERT INTO project_details (project_id, title, description, image_url)
VALUES (3, 'API 문서', 'Swagger UI를 통한 REST API 문서화', '/img/api-docs.jpg');

INSERT INTO project_details (project_id, title, description, image_url)
VALUES (3, '데이터베이스 설계', 'ERD와 테이블 구조 설계도', '/img/api-database.jpg');

-- 프로젝트 4 상세
INSERT INTO project_details (project_id, title, description, image_url)
VALUES (4, '알고리즘 풀이', '문제별 해결 과정과 코드 설명', '/img/algo-solution.jpg');

INSERT INTO project_details (project_id, title, description, image_url)
VALUES (4, '성능 분석', '시간복잡도와 공간복잡도 분석 결과', '/img/algo-analysis.jpg');